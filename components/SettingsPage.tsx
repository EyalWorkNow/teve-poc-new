...
export const SettingsPage: React.FC<SettingsPageProps> = ({ user, onLogout, onBack }) => {
    ...
    return (
        <div className="flex h-full bg-slate-50 dark:bg-[#09090b] text-slate-900 dark:text-slate-200 font-sans overflow-hidden animate-fadeIn transition-colors duration-300">
            
            {/* SIDEBAR */}
            <div className="w-64 border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-[#121212] flex flex-col shrink-0 transition-colors duration-300">
                ...
                <div className="flex-1 py-4 px-2 space-y-1">
                    {tabs.map(tab => (
                        <button
                            ...
                            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg text-xs font-bold uppercase tracking-wider transition-all ${activeTab === tab.id ? 'bg-[#05DF9C]/10 text-[#05DF9C] border border-[#05DF9C]/20' : 'text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white'}`}
                        >
                            <tab.icon size={16} />
                            {tab.label}
                        </button>
            ...
            {/* MAIN CONTENT */}
            <div className="flex-1 flex flex-col min-w-0 bg-slate-50 dark:bg-[#09090b] transition-colors duration-300">
