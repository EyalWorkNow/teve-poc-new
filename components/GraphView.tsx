  ...
  useEffect(() => {
    ...
    const updateGraph = () => {
        ...
        simulation = d3.forceSimulation(nodes)
          .force("link", d3.forceLink(links).id((d: any) => d.id).distance((d: any) => d.isExternal ? 150 : 80))
          // Stronger center pull if pathMode is active to cluster around the core
          .force("charge", d3.forceManyBody().strength((d: any) => d.type === 'HUB' ? -2000 : -400))
          .force("center", d3.forceCenter(width / 2, height / 2))
          .force("collide", d3.forceCollide().radius((d: any) => d.type === 'HUB' ? 80 : 35));
